...
def main():
    """Cloudflare API code - example"""
    #currently uses either ipv4 or ipv6 whatever func my_ip_address returns
    #TODO add flag to explicitly choose between ipv4/ipv6
...
# 
    cf = CloudFlare.CloudFlare(token=config['token'])
